...
public class TelaAviso4 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TelaAviso4 frame = new TelaAviso4();
	...
	public TelaAviso4() {
		setResizable(false);
		setIconImage(Toolkit.getDefaultToolkit().getImage(TelaAviso4.class.getResource("/Imagem/WorkoutGym logo png.png")));
		setTitle("Aviso");
		...
		JLabel lblFuncionrioJCadastrado = new JLabel("Cliente já cadastrado.");
